...
namespace IVI.C.NET.Adapter.ConfigUtility
{
    public partial class Utility : Form
    {
        ...
        private const string AssemblyQualifiedClassNameTemplatePfx = "IVI.C.NET.Adapter.{0}, IVI.C.NET.Adapter, Version=1.0.0.2, Culture=neutral, PublicKeyToken=55d3badc1a673a0b";
        private const string AssemblyQualifiedClassNameTemplateSnk = "IVI.C.NET.Adapter.{0}, IVI.C.NET.Adapter, Version=1.0.0.2, Culture=neutral, PublicKeyToken=d25ace325c488ee2";
